...
Query in this area are simple and **classification-based** (*e.g., "Return documents that containt the word 'pippo'"*). Then, no manipulation is intended, but rather **selection** and **sorting by relevance**.
...
- **Boolean model** based on the 'set' concept.
- Unordered and not nested.
- Quer
