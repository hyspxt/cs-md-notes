...
Unstructured data require specific processing (e.g., analysis algorithms). In particular, **Information Retrieval** is how we call the study of schema-less data. Classical [[+definitions#^def-DBMS|DBMS]] struggle to handle unstructured data, but 
